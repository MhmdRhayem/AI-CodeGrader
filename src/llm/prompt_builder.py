"""
Prompt building utilities for constructing LLM prompts.
"""
...
class PromptBuilder:
    ...
    def format_rubric(rubric: GradingRubric) -> str:
        """
        Format a rubric as readable text.

        Args:
            rubric: GradingRubric object
    ...
    def build_grading_prompt(request: GradingRequest, prompt_template: str) -> str:
        """
        Build a grading prompt from a template and request.

        Args:
            request: GradingRequest object
            prompt_template: Template string with format placeholders
...
class ResponseParser:
    ...
    def extract_json(text: str) -> Dict[str, Any]:
        ...
        Handles cases where JSON might be wrapped in markdown blocks or extra text.
    ...
    def validate_grading_response(response: Dict[str, Any]) -> bool:
        """
        Validate that a grading response has the required fields.
        ...
        """
        required_keys = ["final_grade", "breakdown", "overall_feedback"]
